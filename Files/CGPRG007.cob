      ...
      *-----> VARIAVEIS AUXILIARES UTILIZADA NO PROCESSAMENTO
       01  WS-AREA-AUX.
           ...
           05  PORCE-RJ               PIC 99V9999.
           05  PORCE-MG               PIC 99V9999.
      ...
      *--------------------------------------------------------------*
       010-INICIAR.
           ...
           DISPLAY 'GABRIEL - VINICIUS'
           DISPLAY "ATIVIDADE 7"
           DISPLAY "AVALIACAO FINAL"
      ...
      *--------------------------------------------------------------*
       030-PROCESSAR.
           ...
           IF WS-ESTADO = 'RJ'
              ...
              ADD 1 TO AS-CID-RJ
              ADD AS-PORCE TO PORCE-RJ
           END-IF

           IF WS-ESTADO = 'MG'
              ADD WS-QTD-ACIDENTES TO AS-ACD-MG
              ADD 1 TO AS-CID-MG
              ADD AS-PORCE TO PORCE-MG
           END-IF
       ...
       040-PROCESSAR-SP.
           ...
           .
       041-PROCESSAR-RJ.
           COMPUTE PORCE-RJ = PORCE-RJ / AS-CID-RJ
           MOVE PORCE-RJ    TO WS-PORCE-RJ
           ...
           .
       042-PROCESSAR-MG.
           COMPUTE PORCE-MG = PORCE-MG / AS-CID-MG
           MOVE PORCE-MG    TO WS-PORCE-MG

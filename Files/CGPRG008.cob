      ...
      *=======================*
       PROGRAM-ID.   CGPRG008.
       AUTHOR.       GABRIEL SERRAIN - VINICIUS GUTIERRI.
       INSTALLATION. FATEC SAO CAETANO.
       DATE-WRITTEN. 26/10/2021.
       DATE-COMPILED. 26/04/2023.
      *--------------------------------------------------------------*
      ...
      *--------------------------------------------------------------*
       010-INICIAR.
           ...
           DISPLAY 'GABRIEL SERRAIN SOUZA'
           DISPLAY 'VINICIUS GUTIERRI DA COSTA'
           DISPLAY '-----------------------------'
      ...
      *--------------------------------------------------------------*
       030-PROCESSAR.
           ...
           MOVE WS-SEXO-IN   TO WS-SEXO
           MOVE WS-IDADE-IN  TO WS-IDADE
           MOVE WS-CURSO-IN  TO WS-CURSO
